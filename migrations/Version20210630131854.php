 ...
 */
final class Version20210630131854 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE announcement ADD user_id INT DEFAULT NULL, DROP user');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE announcement ADD user VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP user_id');
    }
}
